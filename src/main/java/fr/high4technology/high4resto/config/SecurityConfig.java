    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http,
        ...
        return http.csrf(ServerHttpSecurity.CsrfSpec::disable)
                ...
                .authorizeExchange(it -> it
                        ...
                        .pathMatchers("/imageCategorie/find/**").permitAll()
                        .pathMatchers("/imageCategorie/delete/**").hasRole("ADMIN")
                        .pathMatchers("/imageCategorie/insert/**").hasRole("ADMIN")
                        .pathMatchers("/imageCategorie/update/**").hasRole("ADMIN")
