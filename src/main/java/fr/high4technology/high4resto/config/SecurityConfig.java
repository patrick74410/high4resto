    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http,
        ...
        return http.csrf(ServerHttpSecurity.CsrfSpec::disable)
                ...
                .authorizeExchange(it -> it
                        ...
                        .pathMatchers("/api/album/find/**").permitAll()
                        .pathMatchers("/api/album/delete/**").hasRole("ADMIN")
                        .pathMatchers("/api/album/insert/**").hasRole("ADMIN")
                        .pathMatchers("/api/album/update/**").hasRole("ADMIN")
